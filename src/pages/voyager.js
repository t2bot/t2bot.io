...
const VoyagerPage = () => (
    <div>
        <h2 className="t2-pageHeading">Matrix Traveler (Voyager)</h2>
        <p className="t2-repoInfo">
            Github Repository: <a href="https://github.com/turt2live/matrix-voyager-bot">turt2live/matrix-voyager-bot</a><br/>
        </p>
