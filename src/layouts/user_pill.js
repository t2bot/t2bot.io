...
export default class UserPill extends React.Component {
    componentWillMount() {
        ...
        axios.get("https://t2bot.io/_matrix/t2bot/user_profile", {params: {user_id: this.props.userId}})
            .then(response => {
    ...
    render() {
        ...
        const avatarMxc = this.state.profile.avatar_url || "mxc://t2l.io/UPAtGsUlQYsPwrtAbnSJYvHV";
        const avatarUrl = "https://t2bot.io/_matrix/media/r0/thumbnail/" + avatarMxc.split('?')[0].substring("mxc://".length) + "?width=120&height=120&animated=true";
